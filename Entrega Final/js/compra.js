...
const checkUser = () => {
  ...
  if (usuario === null) {
    ...
    <h5>Las clases contratadas son: ${clases.join(", ")}.</h5>
  <p>El importe total es: $${costo}<br> Como no cargaste tus datos no podemos enviarte un correo.</br>
  ...
  <a href="../index.html"><button class="btn btn-success">Volver</button></a>`;
    ...
    <h5>Las clases contratadas son: ${clases.join(", ")}.</h5>
  <p>El importe total es: $${costo}<br>Se enviaran a <b>${mail}</b> todas las indicaciones.</p>
  <a href="../index.html"><button class="btn btn-success">Volver</button></a>`;
  }
};
